...
<form method="post" enctype="multipart/form-data" action="insertcourse.php" >

<table>
<tr>  <td> Enter Course Name </td> <td> <input type="text" name="txtcname"> </td> </tr>
<tr>  <td>Select Course Picture </td> <td><input type="file" name="flcourse"></td></tr>
<tr>  <td>Select Course detail url </td> <td><input type="file" name="flurl"></td></tr>
